            ...
            <form method="post" action="ubah.php" enctype="multipart/form-data"> 
                ...
                <div class="input"> 
                    ...
                    <select name="kategori">
                        ...
                        <option <?php echo is_select ('Elektronik', $var['kategori']="Elektronik");?>>Elektronik</option> 
                        <option <?php echo is_select ('Hand Phone', $var['kategori'] = "Handphone");?>>Handphone</option> 
                    </select> 
                </div> 
                <div class="input"> 
